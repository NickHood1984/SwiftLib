...
- **多源元数据管线**：DOI / PMID / arXiv / ISBN / 标题 / CNKI 链接统一入口，支持 CrossRef、OpenAlex、Semantic Scholar、Open Library、Google Books、豆瓣读书、CNKI、万方数据、维普（VIP）与百度学术回退。
...
- **中文文献**：中文期刊/学位论文优先走 CNKI 浏览器上下文；CNKI 无结果、低分或受阻时可回退万方数据、维普或百度学术。
