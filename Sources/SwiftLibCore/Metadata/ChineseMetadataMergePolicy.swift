...
public enum ChineseMetadataMergePolicy {
    private static let chineseSources: Set<MetadataSource> = [.cnki, .wanfang, .vip]

    public static func shouldPreferChineseText(
    ...
    public static func shouldAttemptChineseCorrection(
        seed: MetadataResolutionSeed? = nil,
        inputURL: URL? = nil,
        reference: Reference? = nil,
        existingReference: Reference? = nil
    ...
    public static func merge(backend: Reference, chinese: Reference) -> Reference {
    ...
    public static func mergeResolvedChineseReference(_ chinese: Reference, fallback: Reference) -> Reference {
        var merged = MetadataResolution.mergeReference(primary: chinese, fallback: fallback)
        applyChinesePreferredFields(from: chinese, to: &merged)
        return merged
    }

    public static func mergeRefreshedChineseReference(_ chinese: Reference, existing: Reference) -> Reference {
